...
from fastware.testing import AsyncTestClient, TestClient
...
class TestExports:
    """Verify all Phase 7 symbols are exported from fastware submodules."""

    def test_test_client_exported(self):
        from fastware.testing import TestClient as TC
        assert TC is TestClient

    def test_async_test_client_exported(self):
        from fastware.testing import AsyncTestClient as ATC
        assert ATC is AsyncTestClient

    def test_vite_dev_proxy_exported(self):
        from fastware.middleware import ViteDevProxy as VDP
